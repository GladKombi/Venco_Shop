                ...
                <form action="" class="shadow p-3">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                            ...
                            <input required type="number" class="form-control" placeholder="Entrez le seuil">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                            <label for="">Dettes <span class="text-danger">*</span></label>
